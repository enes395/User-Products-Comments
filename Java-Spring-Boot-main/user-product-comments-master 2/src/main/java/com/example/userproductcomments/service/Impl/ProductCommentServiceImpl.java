...
@Service
@RequiredArgsConstructor // @notnull veya final alanı içeren
 // bir değişken için otomatik constucter oluşturmak için kullanılır, Bu sayede, sınıfın oluşturulma anında bu alanlar için değer atamalarını zorunlu hale getirir
// ve bu alanların değerleri daha sonra değiştirilemez hale gelir.
public class ProductCommentServiceImpl implements ProductCommentService {
    ...
    public ProductCommentResponse save(ProductCommentResponse productCommentRequest) {
